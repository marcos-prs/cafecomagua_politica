POLÍTICA DE PRIVACIDADE - CAFÉ COM ÁGUA
...
• Google Play Services
  Usado para funcionalidades essenciais do sistema Android e para garantir a integração correta do App com a plataforma Google.
  Política de Privacidade: https://policies.google.com/privacy

• Google AdMob
  Usado para exibir anúncios no App. O AdMob pode usar o ID de publicidade do seu dispositivo para fornecer anúncios mais relevantes.
  Política de Privacidade: https://support.google.com/admob/answer/6128543
  Como o Google usa informações: https://policies.google.com/technologies/partner-sites

• Google Play Billing
  Usado para processar compras dentro do aplicativo, como a remoção de anúncios. Nós não coletamos, recebemos ou armazenamos suas informações de pagamento (como dados do cartão de crédito). Todo o processo de pagamento é gerenciado de forma segura pelo Google.
  Política de Privacidade: https://payments.google.com/payments/apis-secure/get_legal_document?ldo=0&ldt=privacynotice
...
• CONFIGURAÇÕES DO DISPOSITIVO
  Você pode gerenciar suas preferências de anúncios nas configurações do seu dispositivo Android em:
  Configurações > Google > Anúncios

• GERENCIAMENTO ONLINE
  Você pode acessar e modificar suas preferências de anúncios personalizados do Google a qualquer momento através do link:
  https://adssettings.google.com/authenticated

• REVOGAÇÃO DE CONSENTIMENTO
  Se você anteriormente consentiu com anúncios personalizados e deseja revogar esse consentimento, pode fazê-lo através do mesmo link acima ou acessando diretamente em nosso app:
  Configurações > Privacidade > Gerenciar Consentimento de Anúncios
...
Caso descubramos que uma criança com menos de 13 anos nos forneceu informações pessoais, nós as excluiremos imediatamente de nossos servidores. 
...
• Configurações de privacidade do Google: https://myaccount.google.com/privacy
